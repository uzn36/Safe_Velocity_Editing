...
def scaled_dot_product_attention_vanilla(query, key, value, attn_mask=None, dropout_p=0.0,
...
class FluxSingleAttnProcessor2_0_vanilla:
    r"""
    Processor for implementing scaled dot-product attention (enabled by default if you're using PyTorch 2.0).
    """
    ...
    def __call__(
        ...
        # the output of sdp = (batch, num_heads, seq_len, head_dim)
        # TODO: add support for attn.scale when we move to Torch 2.1
        hidden_states = scaled_dot_product_attention_vanilla(query, key, value, dropout_p=0.0, is_causal=False)
...
class FluxAttnProcessor2_0_vanilla:
    """Attention processor used typically in processing the SD3-like self-attention projections."""
    ...
    def __call__(
        ...
        #     query, key, value, attn_mask=attention_mask, dropout_p=0.0, is_causal=False
        # )
        hidden_states = scaled_dot_product_attention_vanilla(
